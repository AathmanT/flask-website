...
def preprocess(tweets_data_path,selected_year,selected_month,time_stamps):
    # Reading Tweets
   ...
   # time_stamps = ['Jan','Feb', 'Mar','Apr','May','Jun','Jul','Aug','Sep','Oct', 'Nov', 'Dec']
    ...
    for line in tweets_file:
        ...
        try:
            ...
            created_at=created_at_list[2]
            month=created_at_list[1]
            ...
            try:
                ...
                if(index>=0 and selected_month==month and selected_year==year):
...
#print(preprocess("output.txt","2019","Jan",["1","2","3","27","28"]))
